package net.simplifiedcoding.ui.update
...
@Composable
fun UpdateScreen(viewModel: AuthViewModel?, navController: NavController){
...
// Create a map with updated data.
    val updatedData = Courses(courseName, courseDescription, courseDuration,institute,lecturer,  courseId)
